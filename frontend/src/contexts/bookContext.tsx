...
export const BookProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <BookContext.Provider value={{setBook, book, books, setLoading, loading, error, fetchBooks, fetchBookById, filteredBook, filterBooksByCategory, selectedCategory, resetCategory, filterBooksByTitle }}>
            {children}
