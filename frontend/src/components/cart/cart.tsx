                                ...
                                <div key={index} className="rounded-lg border border-primary_2 bg-white shadow-sm">
                                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div className="flex items-center justify-between md:order-3 md:justify-end">
                                            <CartCounter availableCopies={cartItems.productId.availableCopies || 0} onQuantityChange={() => {}} cartProductId={cartItems.productId.id} />
                                        ...
                                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <button type="button" onClick={() => handleRemoveItem(cartItems.productId.id)} className="inline-flex items-center text-sm font-medium text-red-600 group group-hover:text-red-900">
